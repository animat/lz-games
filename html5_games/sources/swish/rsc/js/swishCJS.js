...
(lib.playagain = function() {
	...
	// Layer 1
	this.text = new cjs.Text("IDS_PLAY_AGAIN", "bold 20px 'Comic Sans MS'", "#A05B29");
	this.text.lineHeight = 22;
	this.text.lineWidth = 269;

	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,255,255,0.1)").s().p("A1dCvIAAlcMAq7AAAIAAFcg");
...
(lib.playgame = function() {
	...
	// Layer 1
	this.text = new cjs.Text("IDS_PLAY", "28px 'Arial'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 30;
	this.text.lineWidth = 380;
	this.text.setTransform(-186.9,-18.8);

	this.text_1 = new cjs.Text("IDS_PLAY", "28px 'Arial'", "#834A21");
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,255,255,0.1)").s().p("A+IC5IAAlwMA8RAAAIAAFwg");
...
(lib.swishCJS = function(mode,startPosition,loop) {
	...
	// Text
	this.text = new cjs.Text("IDS_INSTRUCTIONS", "bold 20px 'Comic Sans MS'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 22;
	...
	this.timeline.addTween(cjs.Tween.get(this.text).wait(2).to({_off:false},0).wait(12).to({scaleX:1.18,scaleY:1.46,x:297.6,y:0.2,text:"",font:NaN,lineHeight:16,lineWidth:204},0).to({_off:true},14));

	this.textWin = new cjs.Text("IDS_WIN", "bold 20px 'Comic Sans MS'", "#FFFFFF");
	this.textWin.textAlign = "center";
	this.textWin.lineHeight = 22;
	this.textWin.lineWidth = 426;
	this.textWin.setTransform(241.8,108.7);
	this.textWin._off = true;

	//this.timeline.addTween(cjs.Tween.get(this.textWin).wait(2).to({_off:false},0).wait(12).to({scaleX:1.18,scaleY:1.46,x:297.6,y:0.2,text:"",font:NaN,lineHeight:16,lineWidth:204},0).to({_off:true},14).wait(19).to({_off:false,scaleX:1,scaleY:1,x:301,y:229.3,text:"You beat Swish!\n Good job!",font:NaN,lineHeight:27,lineWidth:271},0).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.textWin).wait(2).to({_off:true},0).wait(12).to({scaleX:1.18,scaleY:1.46,x:297.6,y:0.2,text:"",font:NaN,lineHeight:16,lineWidth:204},0).to({_off:true},14).wait(19).to({_off:false,scaleX:1,scaleY:1,x:301,y:229.3,font:NaN,lineHeight:27,lineWidth:271},0).wait(1));
