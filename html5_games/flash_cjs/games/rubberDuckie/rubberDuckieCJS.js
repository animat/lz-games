...
(lib.flower = function() {
	...
	this.shape_66.graphics.f().s("#31471B").ss(1,1,1).p("Ag7ALQgCABgBAAAg7ALQAHgEAdgHQAjgMAhALQAaAJgLgIQgLgIgEgCQgBgCgfABQgcAAgsAWg");
	...
	this.shape_91.graphics.f().s("#46812E").ss(0.7,1,1).p("");
...
(lib.duck_win1 = function() {
	...
	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f().s("#000000").ss(1.7,1,1).p("ACXihQgXADgUgHQgPgIAEgPQALgJAPAEQAWgSgTgXQgDAAgbAEQgcAEgRARQgSARAcAoQgEgBgyASQgwATg4AvQg4AvgWBUQgCADgDAVQgDAUAWAFQAagBAZgFQAZgGANAMQAJAQAEAiQADAiAWAGQAYgBAWgMQAXgMAPACQANAIAMAaQANAaAcgEQA1gagLg7QgEg9ACg9QAGg7ARg7QAEgXgEgVQgEgWgYgEg");
...
(lib.background = function() {
	...
	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f().s("#F4C6E0").ss(0.1,1,1).p("");
	this.shape_56.setTransform(268.6,-110.3);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#AE76A5").s().p("");
	...
	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f().s("#31471B").ss(0.1,1,1).p("AhTAPQgBAAgCABAhTAPQAKgFAvgKQA1gPAnAPQAdARgMgMQgLgKgFgDQAAgDgpgDQgmgDhHAgg");
	...
	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f().s("#31471B").ss(0.1,1,1).p("AhRgRQgBAAgCABAhRgRQAMgBAuABQA2ABAkAZQAaAYgMgTQgLgRgEgEQgDgCgwgJQgsgIg0AJg");
	...
	this.shape_110.graphics.f().s("#31471B").ss(1,1,1).p("Ag7ALQgCABgBAAAg7ALQAHgEAdgHQAjgMAhALQAaAJgLgIQgLgIgEgCQgBgCgfABQgcAAgsAWg");
	...
	this.shape_147.graphics.f().s("#F4C6E0").ss(0.1,1,1).p("");
	this.shape_147.setTransform(-281.1,41.3);

	this.shape_148 = new cjs.Shape();
	this.shape_148.graphics.f("#AE76A5").s().p("");
	...
	this.shape_153.graphics.f().s("#31471B").ss(0.1,1,1).p("AhTAPQgBAAgCABAhTAPQAKgFAvgKQA1gPAnAPQAdARgMgMQgLgKgFgDQAAgDgpgDQgmgDhHAgg");
	...
	this.shape_155.graphics.f().s("#31471B").ss(0.1,1,1).p("AhmATQgDABgDACAhmATQAPgHAugNQA9gVA5ATQAuASgUgPQgTgOgHgEQgCgDg1ABQgxABhLAmg");
	...
	this.shape_157.graphics.f().s("#31471B").ss(0.1,1,1).p("AhRgRQgBAAgCABAhRgRQAMgBAuABQA2ABAkAZQAaAYgMgTQgLgRgEgEQgDgCgwgJQgsgIg0AJg");
...
(lib.duck_mc = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{walking:0,wrong:16,correct:21,water:26});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(15).call(this.frame_15).wait(16));
	...
	this.text.setTransform(-0.1,20,1.029,1);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(4).to({y:15},0).wait(8).to({y:14},0).to({_off:true},4).wait(15));

	// Layer 5
	this.instance = new lib.duck3("synched",0);
	this.instance.setTransform(0.4,-0.2,0.682,0.671,0,0,180);

	this.instance_1 = new lib.duck_sad();
	this.instance_1.setTransform(0.2,-1.1,0.674,0.724);

	this.instance_2 = new lib.anim_duck_win();
	this.instance_2.setTransform(-0.1,0.4,0.702,0.705);

	this.instance_3 = new lib.anim_water();
	this.instance_3.setTransform(173.4,-99.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},8).to({state:[]},4).to({state:[{t:this.instance_1}]},4).to({state:[{t:this.instance_2}]},5).to({state:[{t:this.instance_3}]},5).wait(5));

	// 图层 7
	this.instance_4 = new lib.duck2("synched",0);
	this.instance_4.setTransform(0.3,0.1,0.682,0.69,0,0,180);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(4).to({_off:false},0).to({_off:true},4).wait(4).to({_off:false,scaleX:0.67,scaleY:0.68,x:-0.2},0).to({_off:true},4).wait(15));

	// 图层 8
	this.instance_5 = new lib.duck1("synched",0);
	this.instance_5.setTransform(0.4,-0.7,0.682,0.69,0,0,180);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({_off:true},4).wait(27));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-44,-76.7,85.9,152);


(lib.dialogsGameOver = function() {
	this.initialize();
...
// stage content:
(lib.rubberDuckieCJS = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.setTransform(300.6,234.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// bridge2
	this.instance_1 = new lib.bridge2("synched",0);
	this.instance_1.setTransform(299.9,141.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// bridge1
	this.instance_2 = new lib.bridge("synched",0);
	this.instance_2.setTransform(299.3,300.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// banner
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#290000").s().p("AAmCQQgrgOgIgBIgCAAQhFASgBgDQgDgQAQgWQAUgbACgIQALgpgMhSQgRg8AEghQAVgDADA7QACAggCAuQAIAEABAIIAAAUQABASAGALIAOAWQAGALAGAcQAEAHAuAAQAmABgEAOQgEANgWAAQgKAAgMgCg");
	this.shape.setTransform(555.1,386.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#290000").s().p("AgGCbQgGgJgMgDIgKAAQADAAgBghQAMgYAEgNQAKgcAEgWQAAgiACgSIALg5IAVhZIADAcQAAAdgDApQgGBFgCAIQgCAJgHAQQgDANACAcQgBATADAgQALA7gBAAQgTAAgNgVgAAgivIAAAAIAAAAg");
	this.shape_1.setTransform(534.5,384);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#290000").s().p("");
	this.shape_2.setTransform(527.4,367.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#4B1500").s().p("");
	this.shape_3.setTransform(539.5,369.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(2.7,1,1).p("");
	this.shape_4.setTransform(541.9,369);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#693400").s().p("");
	this.shape_5.setTransform(541.9,369);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#290000").s().p("AAmCQQgrgOgIgBIgCAAQhFASgBgDQgDgQAQgWQAUgbACgIQALgpgMhSQgRg8AEghQAVgDADA7QACAggCAuQAIAEABAIIAAAUQABASAGALIAOAWQAGALAGAcQAFAHAtAAQAnABgFAOQgEANgWAAQgKAAgMgCg");
	this.shape_6.setTransform(76.6,386.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#290000").s().p("AgGCbQgGgJgMgDIgKAAQADAAgBghQAMgYAEgNQAKgcAEgWQAAgiACgSIALg5IAVhZIADAcQAAAdgDApQgGBFgCAIQgCAJgHAQQgDANACAcQgBATADAgQALA7gBAAQgTAAgNgVgAAgivIAAAAIAAAAg");
	this.shape_7.setTransform(56,384);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#290000").s().p("");
	this.shape_8.setTransform(48.9,367.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#4B1500").s().p("");
	this.shape_9.setTransform(61,369.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(2.7,1,1).p("");
	this.shape_10.setTransform(63.4,369);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#693400").s().p("");
	this.shape_11.setTransform(63.4,369);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(1.8,1,1).p("EAkhADVMhJBAAAIAAmpMBJBAAAg");
	this.shape_12.setTransform(303.9,360.6);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#BF8442").s().p("EgkgADVIAAmpMBJBAAAIAAGpg");
	this.shape_13.setTransform(303.9,360.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	// BG
	this.instance_3 = new lib.background("synched",0);
	this.instance_3.setTransform(296.9,200.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(286.9,196.8,620,407.4);
