...
(lib.playBtn = function() {
	...
	// Layer 1
	this.text = new cjs.Text("Viens jouer!", "36px 'Arial'", "#003300");
...
(lib.playAgain_btn = function() {
	...
	// Layer 1
	this.text = new cjs.Text("Play again?", "bold 20px 'Comic Sans MS'", "#003300");
	this.text.textAlign = "center";
	this.text.lineHeight = 22;
...
(lib.mantisCJS = function(mode,startPosition,loop) {
	...
	this.text = new cjs.Text("Tape les réponses correctes aux indications en haut de l'écran pour aider Mantis a monter juste a son bébé.", "20px 'Arial'", "#000066");
	this.text.lineHeight = 22;
