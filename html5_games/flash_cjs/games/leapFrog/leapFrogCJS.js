...
(lib.playgame = function() {
	...
	this.text_1 = new cjs.Text("Play the game", "28px 'Arial'", "#0F0099");
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(131,74,33,0)").s().p("A2ICLIAAkVMAqXAAAIAAAPIB5AAIAAD9Ih5AAIAAAJg");
...
(lib.land_left = function() {
	...
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#D19369").s().p("AgKA+QAYguADgLIAFgYQACgcAAgqQAFAggHAmQgBAVgCAMQgJBGgiAkQgFgXATgjgAARh3IAHAPIAAAPQgDgQgEgOg");
	...
	this.shape_62.graphics.f("#126D18").s().p("");
...
(lib.leapFrogCJS = function(mode,startPosition,loop) {
	...
	this.text_2 = new cjs.Text("Type the correct answers to help the frog make it to the other side of the pond.", "24px 'Arial'");
