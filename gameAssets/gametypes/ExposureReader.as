/**
 * This class reads the XML for all ExposureGames (e.g. On the Air)
 * and turns the XML into Question objects in the QuestionList.
 */
class gametypes.ExposureReader extends AbstractXMLReader implements XMLReaderInterface {
	
	public function ExposureReader(parentScope:Object, fileName:String, initCallBack:Function) {
